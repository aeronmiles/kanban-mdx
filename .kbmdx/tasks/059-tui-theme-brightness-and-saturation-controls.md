...
## Context
kbmdx allows real-time per-session tuning of the Glamour markdown theme. The Go version currently only supports cycling themes (`t`) but has no brightness/saturation adjustment.
