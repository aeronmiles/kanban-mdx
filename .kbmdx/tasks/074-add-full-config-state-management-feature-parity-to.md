...
kbmdx already mirrors most of the Go config system (v14 schema, 13 migrations, validation, config get/set, init flags, status enforcement). However, several gaps remain in enforcement logic, validation rigor, and TUI state persistence.
