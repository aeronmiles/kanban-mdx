...
pub(super) fn render_help(app: &App, frame: &mut Frame) {
    ...
    let entries: &[(&str, &str, &str, &str)] = &[
        ...
        ("J/K", "Half-page scroll", "y", "Yank task content"),
        ("d/u", "Half-page (vim)", "Y", "Yank task path"),
        ("g/G", "Top / bottom", "o", "Open in $EDITOR"),
        ("{/}", "Prev/next heading", "t", "Cycle theme"),
        ("1-9", "Jump to heading", "z/Z", "Fold deeper/shallower"),
        ("/", "Find in text", "</>", "Narrow/widen width"),
        ("n/N", "Find next/prev", "v", "Visual mode (select)"),
        ("", "", ":/^G", "Go to task #"),
        ("", "", "q/Esc", "Back to board"),
    ];
